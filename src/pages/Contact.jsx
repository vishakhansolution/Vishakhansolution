...
import { Mail, Globe, Linkedin, Instagram, Facebook, MessageCircle, ArrowUpRight, ShieldCheck, MapPin , Phone} from 'lucide-react';
...
const Contact = () => {
  ...
  {/* WhatsApp - Updated to Vishakhan Solution */}
  <a 
    href="https://wa.me/919344330970?text=Hi%20Vishakhan%20Solution%2C%20I'm%20interested%20in%20your%20services..." 
  ...
  {/* Voice Call - New Contact Number Section */}
  <a 
    href="tel:+919344330970" 
    className="flex items-center justify-between p-5 bg-slate-50 hover:bg-slate-900 group transition-all duration-500" 
    data-aos="fade-right" data-aos-delay="200"
  >
    <div className="flex items-center gap-4">
      <Phone size={18} className="text-slate-400 group-hover:text-blue-500 transition-colors" />
      <span className="text-[10px] font-bold tracking-widest uppercase text-slate-900 group-hover:text-white">Voice Call</span>
    </div>
    <span className="text-[9px] text-slate-300 group-hover:text-white/80">+91 93443 30970</span>
  </a>

  {/* Instagram */}
  <a 
    href="#" 
    className="flex items-center justify-between p-5 bg-slate-50 hover:bg-[#E1306C] group transition-all duration-500" 
  ...
  <a 
    href="#" 
    className="flex items-center justify-between p-5 bg-slate-50 hover:bg-[#1877F2] group transition-all duration-500" 
